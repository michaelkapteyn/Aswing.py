...
class aswGeometry:
	...
	def writetoasw(self, filepath=None):
		if filepath is None:
		...
		with open(filepath, 'w+') as f:
			...
			f.write(str(self.constants.gravity)+"\t"+str(self.constants.sea_level_air_density)+"\t"+str(self.constants.sea_level_speed_of_sound)+"\n")
			f.write(end)
			f.write(comment)
